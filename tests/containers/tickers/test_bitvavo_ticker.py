...
from bt_api_bitvavo.tickers import BitvavoRequestTickerData
...
class TestBitvavoRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BitvavoRequestTickerData(
            data, symbol_name="BTC-EUR", asset_type="SPOT", has_been_json_encoded=True
        )
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = BitvavoRequestTickerData(
            {}, symbol_name="BTC-EUR", asset_type="SPOT", has_been_json_encoded=True
        )
